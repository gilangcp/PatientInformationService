...
/**
 * GetPrescriptionAndDiagnosisDetail.java
 *
 ...
 */
            ...
            /**
            *  GetPrescriptionAndDiagnosisDetail bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPrescriptionAndDiagnosisDetail
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetPrescriptionAndDiagnosisDetail",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetPrescriptionAndDiagnosisDetail",
    ...
    public static class Factory{
        ...
        */
        public static GetPrescriptionAndDiagnosisDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPrescriptionAndDiagnosisDetail object =
                new GetPrescriptionAndDiagnosisDetail();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPrescriptionAndDiagnosisDetail".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPrescriptionAndDiagnosisDetail)invoiceservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
