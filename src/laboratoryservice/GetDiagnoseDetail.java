 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetDiagnoseDetail",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetDiagnoseDetail",
    ...
    public static class Factory{
        ...
        */
        public static GetDiagnoseDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetDiagnoseDetail".equals(type)){
                                ...
                                return (GetDiagnoseDetail)laboratoryservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
